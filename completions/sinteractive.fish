...
complete -c sinteractive -n "__fish_sinteractive_needs_command" -f -a "__pane-cwd" -d 'Runs on the node over ssh: the pane\'s live working directory'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand list" -l full -d 'Also show node, partition, and elapsed/limit'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand claude; and __fish_seen_subcommand_from hook" -f -a "agent-guard" -d 'PreToolUse (Agent): require confirmation before a Fable subagent'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -s h -l help -d 'Print help'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "session-start" -d 'SessionStart: print the agent briefing'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "prompt" -d 'UserPromptSubmit: warn when walltime is short'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "worktree-create" -d 'WorktreeCreate: make the worktree on the cluster\'s scratch filesystem'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "worktree-remove" -d 'WorktreeRemove: remove a worktree the create hook made'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "agent-guard" -d 'PreToolUse (Agent): require confirmation before a Fable subagent'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and not __fish_seen_subcommand_from session-start prompt worktree-create worktree-remove agent-guard help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and __fish_seen_subcommand_from agent-guard" -s h -l help -d 'Print help'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand hook; and __fish_seen_subcommand_from help" -f -a "agent-guard" -d 'PreToolUse (Agent): require confirmation before a Fable subagent'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand __pane-cwd" -s h -l help -d 'Print help'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "list" -d 'List running sessions'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "status" -d 'Show one session\'s status'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "cancel" -d 'Cancel a session'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "queue" -d 'Your job queue: running, pending (with reasons), and recent history'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "monitor" -d 'Live CPU/GPU/process view of a session\'s node, or any host'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "quota" -d 'Storage quota (Bodhi quota daemons; unavailable on other clusters)'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "doctor" -d 'Check this install and, optionally, every compute node'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "session" -d 'Drive a session from outside: ensure, peek, send, events'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "gen" -d 'Generated output: completions, man page, JSON schemas'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "ensure" -d 'Superseded by `session ensure`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "peek" -d 'Superseded by `session peek`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "send" -d 'Superseded by `session send`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "events" -d 'Superseded by `session events`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "refresh" -d 'Superseded by `status --refresh`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "snapshot" -d 'Superseded by `monitor --once`'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "hook" -d 'Superseded by `claude hook`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "statusline" -d 'Superseded by `claude statusline`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "mcp" -d 'Superseded by `claude mcp`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "install-claude" -d 'Superseded by `claude install`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "completions" -d 'Superseded by `gen completions`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "man" -d 'Superseded by `gen man`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "schema" -d 'Superseded by `gen schema`'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "__job" -d 'The batch job body: starts zellij on the node and babysits it'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "__attach" -d 'Runs on the node over ssh: attach the local zellij client'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "__popup" -d 'In-session floating views'
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and not __fish_seen_subcommand_from launch attach list status cancel queue monitor quota doctor session claude gen ensure peek send events refresh snapshot agent-context hook statusline mcp install-claude completions man schema __job __attach __popup __pane-cwd help" -f -a "__pane-cwd" -d 'Runs on the node over ssh: the pane\'s live working directory'
...
complete -c sinteractive -n "__fish_sinteractive_using_subcommand help; and __fish_seen_subcommand_from hook" -f -a "agent-guard" -d 'PreToolUse (Agent): require confirmation before a Fable subagent'
